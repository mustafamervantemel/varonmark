        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-20">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold text-purple-900 mb-4">Trendyol Hizmet Paketlerimiz</h2>
              <p className="text-xl text-purple-700 max-w-3xl mx-auto">
                İhtiyacınıza uygun paket seçin, Trendyol'da başarınızı garanti altına alın
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              ...
              <div className="bg-gradient-to-br from-orange-50 to-red-50 rounded-3xl p-8 border-2 border-orange-200 hover:shadow-xl transition-all">
                <div className="text-center mb-6">
                  <div className="w-16 h-16 bg-gradient-to-r from-orange-500 to-red-500 rounded-full flex items-center justify-center mx-auto mb-4">
                    <img src="/src/media/trendyol.jpeg" alt="Trendyol" className="w-10 h-10 rounded-lg" />
                  </div>
                ...
                <div className="space-y-4 mb-8">
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-orange-700 text-sm">Trendyol mağazanızın profesyonel kurulumu</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-orange-700 text-sm">Trendyol paneli kullanımı hakkında detaylı eğitim</p>
                    </div>
                  </div>
                </div>

                <button className="w-full bg-gradient-to-r from-orange-500 to-red-500 text-white py-3 rounded-lg font-semibold transition-all hover:scale-105 shadow-lg">
                  Hemen Başla
                </button>
              </div>
              ...
              <div className="bg-gradient-to-br from-purple-50 to-indigo-50 rounded-3xl p-8 border-2 border-purple-300 hover:shadow-xl transition-all relative">
                ...
                <button className="w-full bg-gradient-to-r from-purple-500 to-indigo-500 text-white py-3 rounded-lg font-semibold transition-all hover:scale-105 shadow-lg">
                  Hemen Başla
                </button>
              </div>
            </div>
          ...
          <div className="mt-16 text-center">
            <h2 className="text-3xl font-bold mb-4">Trendyol'da Başarı Hikayeniz Başlasın!</h2>
            <p className="text-gray-600 mb-8 max-w-2xl mx-auto">
              Trendyol'da satış yapmak istiyorsanız, doğru adrestesiniz. Uzman ekibimizle birlikte satışlarınızı artırın.
            </p>
